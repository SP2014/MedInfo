...
public enum ElementSetter {
    ...
    MEDIA_CONTENT("media:content", new AttributeSetter() {
        ...
        public void set(RssElement element, Attributes attributes) {
            final int height = MediaAttributes.intValue(attributes, MEDIA_CONTENT_HEIGHT, DEFAULT_DIMENSION);
            final int width = MediaAttributes.intValue(attributes, MEDIA_CONTENT_WIDTH, DEFAULT_DIMENSION);
            final String url = MediaAttributes.stringValue(attributes, MEDIA_CONTENT_URL);
    ...
    MEDIA_THUMBNAIL("media:thumbnail", new AttributeSetter() {
        ...
        public void set(RssElement element, Attributes attributes) {
            ...
            element.addMediaThumbnail(new MediaThumbnail(Uri.parse(url), height, width));
            //element.setMediaLink(url);
        }
    }),
