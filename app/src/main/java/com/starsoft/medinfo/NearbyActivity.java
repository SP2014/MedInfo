...
import com.starsoft.medinfo.helpers.GetNearbyPlacesData;
...
public class NearbyActivity extends AppCompatActivity implements GoogleMap.OnMyLocationButtonClickListener,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker in Durg, India, and move the camera.
        LatLng durg = new LatLng(21.190449, 81.284917);
        //mMap.addMarker(new MarkerOptions().position(durg).title("Durg, India"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(durg));
        String url = getUrl(21.190449, 81.284917, "hospital");
